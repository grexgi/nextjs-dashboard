  ...
  return (
    <div className="mb-4 flex flex-grow h-min md:ps-24 flex-col overflow-x-clip rounded-xl bg-green-50 p-3">
      ...
      <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 md:grid-cols-4">
        ...
        <GaugeChart title='Nitrogen' index={n} minValue={0} maxValue={1200} minSafe={150 / 1000} maxSafe={1000 / 1000} />
        <GaugeChart title='Fosfor' index={p} minValue={0} maxValue={1200} minSafe={150 / 1000} maxSafe={1000 / 1000} />
        <GaugeChart title='Kalium' index={k} minValue={0} maxValue={1200} minSafe={150 / 1000} maxSafe={1000 / 1000} />
      </div>
